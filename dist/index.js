...
class TwitterApiv1ReadWrite extends client_v1_read_1.default {
    ...
    async getUploadMediaRequirements(file, { mimeType, type, target, longVideo } = {}) {
        ...
        try {
            ...
            // Get the mimetype
            const realMimeType = media_helpers_v1_1.getMimeType(file, type, mimeType);
            ...
            if (realMimeType === types_1.EUploadMimeType.Mp4 && ((!mimeType && !type && target !== 'dm') || longVideo)) {
                ...
                mediaCategory = media_helpers_v1_1.getMediaCategoryByMime(realMimeType, target !== null && target !== void 0 ? target : 'tweet');
            }
            return {
                fileHandle,
                mediaCategory,
...
function getMimeByName(name) {
    ...
    helpers_1.safeDeprecationWarning({
...
const publishTweet = __nccwpck_require__(196);
